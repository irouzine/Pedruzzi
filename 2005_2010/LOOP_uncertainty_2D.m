...
tic
  ...
  %                       AVERAGE OVER MULTIPLE RUNS FOR EACH ARAMTER
  %                       VALUES
...
% subplot(1,2,1),
surf(Dw_i,dv_i,Ufe), xlabel('Dw'), ylabel('dv'), title('detection plateau'),  set(gca,'FontSize', 12), 
...
%%
save('Plateau_na_2010.mat', 'dv_i', 'Dw_i', 'Ufe', 'xU_i')
