...
Dw_cal_1 = [.0 .0 .0 .025 .025 .025 .05 .05 .05]; 
dv_cal_1 = [.05 .1 .15 .05 .1 .15 .05 .1 .15 ];    

Dw_cal_2 = [.0 .0 .0 .025 .025 .025 .05 .05 .05]; 
dv_cal_2 = [.05 .1 .15 .05 .1 .15 .05 .1 .15 ];  
...
%     clc
    ...
    load Data_NA_05_08; str = ('NA H1N1 2005-2008 (CONS. 2005-2008)'); fig = 50; Tim = 1; 
    
    elseif tim == 2
     [Headers, Sequences] = multialignread('full_align_NA_05_08aa.aln');
    load Data_NA_05_08aa; str = ('NA H1N1 2005-2008 (CONS. 2005-2006)'); fig = 60; Tim = 2; 
...
g1 = figure(100);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'hist_1','-dpdf','-r0')

g1 = figure(200);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'hist_2','-dpdf','-r0')

g1 = figure(234);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'plateaus','-dpdf','-r0')

g1 = figure(51);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'A1','-dpdf','-r0')
g1 = figure(52);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'B1','-dpdf','-r0')
g1 = figure(53);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'C1','-dpdf','-r0')
g1 = figure(54);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'D1','-dpdf','-r0')
g1 = figure(55);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'E1','-dpdf','-r0')
g1 = figure(56);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'F1','-dpdf','-r0')
g1 = figure(57);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'G1','-dpdf','-r0')
g1 = figure(58);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'H1','-dpdf','-r0')
g1 = figure(59);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'I1','-dpdf','-r0')


g1 = figure(61);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'A2','-dpdf','-r0')
g1 = figure(62);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'B2','-dpdf','-r0')
g1 = figure(63);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'C2','-dpdf','-r0')
g1 = figure(64);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'D2','-dpdf','-r0')
g1 = figure(65);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'E2','-dpdf','-r0')
g1 = figure(66);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'F2','-dpdf','-r0')
g1 = figure(67);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'G2','-dpdf','-r0')
g1 = figure(68);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'H2','-dpdf','-r0')
g1 = figure(69);  set(g1, 'Units', 'Normalized', 'OuterPosition', [0 0 1 1]); set(g1,'Units','Inches');pos = get(g1,'Position'); set(g1,'PaperPositionMode','Auto','PaperUnits','Inches','PaperSize',[pos(3), pos(4)]);
print(g1,'I2','-dpdf','-r0')
