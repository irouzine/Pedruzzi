...
str = sprintf('Th=%g, E=%g, muL=%g, s_0=%g, f_0=%g  N=%d, L=%g, t=%g,  DOUBLE ARCHEs', th, E_st, U, s0, f0/L, N, L, td); %disp('a=0, pos epi.'), 


figure(1)
subplot(2,2,ii+1), plot(bc,ac,'LineWidth',2), title(str),  hold on, axis square, set(gca,'FontSize',16),xlabel('UFE'),ylabel('# of sites')
...
figure(1)
subplot(2,2,ii+2), plot(G,'NodeColor','k','EdgeAlpha',0.9);
