...
subplot(sb,2,sup+2), h = plot(GsuB,'NodeColor','k','EdgeColor','r','EdgeAlpha',0.5, 'EdgeLabel',GsuB.Edges.Weight,'LineWidth',2); axis square% separate each subclusters (greater than two sites)
xlabel('min(UFE_{AB0})'), 
