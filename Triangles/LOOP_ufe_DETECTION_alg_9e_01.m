...
subplot(sb,2,1+sp), sub = plot(Gsub,'NodeColor','k','EdgeAlpha',0.5, 'EdgeLabel',Gsub.Edges.Weight,'LineWidth',2); axis square, hold on % separate each subclusters (greater than two sites)
...
UFEiii(it,i0) = 1 - (log(f11/f00))/((log(f01*f10/f00^2)));  % UFE for triplets
...
subplot(sb,2,sp+2), h = plot(GsuB,'NodeColor','k','EdgeColor','r','EdgeAlpha',0.5, 'EdgeLabel',GsuB.Edges.Weight,'LineWidth',2); axis square% separate each subclusters (greater than two sites)
% subplot(2,2,4), h1 = plot(GsuB1,'NodeColor','k','EdgeColor','r','EdgeAlpha',0.5, 'EdgeLabel',GsuB.Edges.Weight,'LineWidth',2); axis square% separate each subclusters (greater than two sites)     
tag(TRUE) = {'true'}; 
tag(~TRUE) = {'false'};
