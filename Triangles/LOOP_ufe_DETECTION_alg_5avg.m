...
subplot(1,2,cl), sub = plot(Gsub,'NodeColor','k','EdgeAlpha',0.5, 'EdgeLabel',Gsub.Edges.Weight,'LineWidth',2); axis square% separate each subclusters (greater than two sites)
...
%     UFEiii = zeros(nt,3);
   ...
   test = size(Gsub.Nodes,1); % # of bonds to be tested
