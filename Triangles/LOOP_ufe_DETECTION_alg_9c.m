...
ind_true = find(index_true); UFE_true = UFE(ind_true,:);                                                                          
ind_indi = find(index_indi); UFE_indi = UFE(ind_indi,:);  
...
%%
% figure(2)
% plot(bt,at,'r','LineWidth',2), title(str),  hold on, axis square, set(gca,'FontSize',16),xlabel('UFE '),ylabel('# of pairs')
% plot(bi,ai,'b','LineWidth',2), hold on, 
% % plot(bc,ac,'g','LineWidth',2), hold on, 
% legend('red TRUE', 'blue INDI')
